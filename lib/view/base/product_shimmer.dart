                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(height: 15, width: double.infinity,margin: const EdgeInsets.only(top: 10.0), color: Colors.grey[300]),
                                Flexible(
                                  child: Container(
                                    child: Row(
                                      mainAxisAlignment:
                                      ...
                                      children: [
                                        Flexible(
                                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                            ...
                                            FittedBox(
                                              fit: BoxFit.contain,
                                              child: Container(height: 15, width: 25, color: Colors.grey[300]),
                                            ),
