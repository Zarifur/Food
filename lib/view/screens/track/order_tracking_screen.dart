...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> _statusList = ['pending', 'accepted', 'declined' , 'canceled'];
                ...
                child: Center(
                  child: Consumer<OrderProvider>(
                    builder: (context, order, child) {
                      ...
                      if(_status != null && _status == _statusList[2] || _status == _statusList[3]) {
                        return Column(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if(_status == _statusList[0] ||
                                          _status == _statusList[1]) TimerView(),
