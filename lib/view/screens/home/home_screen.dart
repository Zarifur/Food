...
import 'package:flutter_restaurant/view/screens/home/widget/exclusive_product_view.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadData(BuildContext context, bool reload) async {
    ...
    if(reload) {
      ...
      Provider.of<ProductProvider>(context, listen: false).getExclusiveProductList(
        context, false, Provider.of<LocalizationProvider>(context, listen: false).locale.languageCode,
      );
                ...
                child: Column(
                  children: [
                    SizedBox(
                      ...
                      //Added by Me Popular products hidden
                      ...
                      //Added by Me(Exclusive products)
                        ResponsiveHelper.isDesktop(context) ? Row(
                          mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Padding(
                              padding: EdgeInsets.fromLTRB(0, 20, 0, 20),
                              child: Text("Exclusive Items", style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_OVER_LARGE)),
                            ),
                          ],
                        ) :
                        Padding(
                          padding: EdgeInsets.fromLTRB(10, 20, 10, 10),
                          child: TitleWidget(title: "Exclusive Items"),
                        ),
                        ExclusiveProductView(),
                        ...
                        ResponsiveHelper.isDesktop(context) ? Row(
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsets.fromLTRB(0, 20, 0, 20),
                              child: Text("All Items", style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_OVER_LARGE)),
                            ),
                          ],
                        ) :
                        Padding(
                          padding: EdgeInsets.fromLTRB(10, 20, 10, 10),
                          child: TitleWidget(title: "All Items"),
                        ),
