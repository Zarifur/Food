      ...
      builder: (context, setMenu, child) {
        return Column(
          children: [
                ...
                Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text("Meal Deals", style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_OVER_LARGE)),
                    ),
                  ],
                ),
                Positioned.fill(
            ...
            SizedBox(
              height: 360,
              child: setMenu.setMenuList != null ? setMenu.setMenuList.length > 0 ? SetMenuPageView(setMenuProvider: setMenu, pageController: pageController) : Center(child: Text("No Meal Deal is available")) : SetMenuShimmer(),
            ),
          ],
        );
      },
