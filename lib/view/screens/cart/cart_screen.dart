...
class _CartScreenState extends State<CartScreen> {
  ...
  void initState() {
    ...
    Provider.of<TableProvider>(context,listen: false).getTableList(context, false);
  }
  @override
      ...
      body: Consumer<OrderProvider>(
          ...
          return Consumer<CartProvider>(
            builder: (context, cart, child) {
              ...
              double _tax = 0;
              double _addOns = 0;
              double _extraItemsPrice = 0;
              double _sidesAndDrinksPrice = 0;
              cart.cartList.forEach((cartModel) {
                ...
                //TODO: Add meal deal price
                if(cartModel.isMeal == 1){
                  if(cartModel.cartSide != null && cartModel.cartSide.price != -1){
                    _sidesAndDrinksPrice += cartModel.cartSide.price * cartModel.quantity;
                  }
                  if(cartModel.cartDrink != null && cartModel.cartDrink.price != -1){
                    _sidesAndDrinksPrice += cartModel.cartDrink.price * cartModel.quantity;
                  }
                  if(cartModel.cartDip != null && cartModel.cartDip.price != -1){
                    _sidesAndDrinksPrice += cartModel.cartDip.price * cartModel.quantity;
                  }
                }
                _extraItemsPrice = _extraItemsPrice + (cartModel.itemsCost * cartModel.quantity);
              });
              double _subTotal = _itemPrice + _tax + _addOns + _extraItemsPrice + _sidesAndDrinksPrice;
              ...
              double _orderAmount = _itemPrice + _addOns + _extraItemsPrice;
                                      ...
                                      children: [
                                        ...
                                        padding: ResponsiveHelper.isDesktop(context) ? EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_LARGE,vertical: Dimensions.PADDING_SIZE_LARGE) : EdgeInsets.all(0),
                                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                              ...
                                              //DeliveryOptionButton(value: 'table_order', title: 'Table Order', kmWiseFee: _kmWiseCharge),
                                              ...
                                              //     crossAxisAlignment: CrossAxisAlignment.start,
                                              //     children: [
                                              //       Text('Table', style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                              //       TextFormField(
                                              ...
                                              // Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                              //   Text("Extra Items", style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                              //   Text('(+) ${PriceConverter.convertPrice(context, _extraItemsPrice)}', style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                              // ]),
                                              // SizedBox(height: 10),

                                              // Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                              //   Text("Sides and Drinks", style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                              //   Text('(+) ${PriceConverter.convertPrice(context, _sidesAndDrinksPrice)}', style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                              // ]),
                                              // SizedBox(height: 10),
...
class CartListWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      //TODO: Customise to show if it is mea deal
