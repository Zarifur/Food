          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                Text(orderItem.orderStatus[0].toUpperCase()+orderItem.orderStatus.substring(1), style: rubikRegular.copyWith(color: Theme.of(context).primaryColor)),
              ]),
            ]),
          ),
        ]),
              ...
              onTap: () async {
                if(isRunning) {
                  ...
                  orderDetails.forEach((orderDetail) {
                    ...
                    //TODO:This is empy fix it alse null
                    List<SaveItem> itms = [];
                    double itemsCost = 0;
                    ...
                    _cartList.add(CartModel(
                        ...
                        orderDetail.taxAmount, _addOnList,itms,itemsCost,null,null,null,0, orderDetail.productDetails
                    )
                    );
