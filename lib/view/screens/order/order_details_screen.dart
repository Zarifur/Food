    ...
    return Scaffold(
      ...
      body: Consumer<OrderProvider>(
        builder: (context, order, child) {
          ...
          try{
            if(order.orderDetails != null) {
              ...
              for(OrderDetailsModel orderDetails in order.orderDetails) {
                ...
                _extraItemsPrice += (orderDetails.itemsPrice * orderDetails.quantity); 
                if(orderDetails.isMeal == 1){
                  _mealItemsPrice += (orderDetails.mealItemPrice * orderDetails.quantity);
                }
          ...
          double _subTotal = _itemsPrice + _tax + _addOns + _extraItemsPrice +_mealItemsPrice;
          double _total = _itemsPrice + _addOns + _extraItemsPrice +_mealItemsPrice - _discount - _extraDiscount + _tax + deliveryCharge - (order.trackModel != null
