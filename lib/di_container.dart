...
import 'package:flutter_restaurant/data/repository/table_repo.dart';
...
Future<void> init() async {
  ...
  //Added by Me
  sl.registerLazySingleton(() => TableRepo(dioClient: sl()));
  ...
  //Added by Me
  sl.registerFactory(() => TableProvider(tableRepo: sl()));
