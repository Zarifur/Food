...
class AppConstants {
  static const String APP_NAME = 'PFC Online';
  static const double APP_VERSION = 9.1;
  // static const String BASE_URL = 'http://192.168.1.106:8000';
  static const String BASE_URL = 'https://admin.originalfriedchicken.co.uk';
  // static const String BASE_URL = 'https://restaurant.codelakes.com';
  static const String CATEGORY_URI = '/api/v1/categories';
  static const String BANNER_URI = '/api/v1/banners';
  static const String LATEST_PRODUCT_URI = '/api/v1/products/latest';
  static const String POPULAR_PRODUCT_URI = '/api/v1/products/popular';
  // Added by Me
  static const String EXCLUSIVE_PRODUCT_URI = '/api/v1/products/exclusive';
  static const String TABLE_URI = '/api/v1/table/list';
  static const String TABLE_ORDER_URI = '/api/v1/table/order/place';
